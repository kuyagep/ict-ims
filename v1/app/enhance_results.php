    ...
    <div class="container-fluid">
        ...
        <?php 
            ...
            //     $s_search = !empty($_GET['e']);
                ...
                INNER JOIN category ON `category`.`category_id`=`inv_ict`.`category_id` WHERE `item_name` LIKE '%$s_search%' OR `firstname` LIKE '%$s_search%' OR `lastname` LIKE '%$s_search%' OR `office_name` LIKE '%$s_search%' ");
